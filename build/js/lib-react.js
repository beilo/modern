(self['webpackChunk_beilo_modern'] = self['webpackChunk_beilo_modern'] || []).push([["lib-react"], {
"./node_modules/.pnpm/react-dom@18.2.0_react@18.2.0/node_modules/react-dom/cjs/react-dom.development.js": function (module, exports, __webpack_require__) {
'use strict';
...
(function() {
    'use strict';
    var setSuppressWarning = function setSuppressWarning(newSuppressWarning) {
    ...
    var checkAttributeStringCoercion = function checkAttributeStringCoercion(value, attributeName) {
    ...
    var checkPropStringCoercion = function checkPropStringCoercion(value, propName) {
        if (willCoercionThrow(value)) {
            error("The provided `%s` prop is an unsupported type %s. This value must be coerced to a string before before using it here.", propName, typeName(value));
            return testStringCoercion(value);
        }
    };
    var checkCSSPropertyStringCoercion = function checkCSSPropertyStringCoercion(value, propName) {
        if (willCoercionThrow(value)) {
            error("The provided `%s` CSS property is an unsupported type %s. This value must be coerced to a string before before using it here.", propName, typeName(value));
            return testStringCoercion(value);
        }
    };
    var checkHtmlStringCoercion = function checkHtmlStringCoercion(value) {
        if (willCoercionThrow(value)) {
            error("The provided HTML markup uses a value of unsupported type %s. This value must be coerced to a string before before using it here.", typeName(value));
            return testStringCoercion(value);
        }
    };
    var checkFormFieldValueStringCoercion = function checkFormFieldValueStringCoercion(value) {
        if (willCoercionThrow(value)) {
    ...
    var PropertyInfoRecord = function PropertyInfoRecord(name, type, mustUseProperty, attributeName, attributeNamespace, sanitizeURL, removeEmptyString) {
    ...
    var getValueForAttribute = function getValueForAttribute(node, name, expected, isCustomComponentTag) {
    ...
    var getWrappedName$1 = function getWrappedName$1(outerType, innerType, wrapperName) {
        var functionName = innerType.displayName || innerType.name || '';
        return outerType.displayName || (functionName !== '' ? wrapperName + "(" + functionName + ")" : wrapperName);
    };
    var getContextName$1 = function getContextName$1(type) {
        return type.displayName || 'Context';
    };
    var getComponentNameFromFiber = function getComponentNameFromFiber(fiber) {
    ...
    var postMountWrapper = function postMountWrapper(element, props, isHydrating) {
        var node = element;
    ...
    var setReplayingEvent = function setReplayingEvent(event) {
    ...
    var resetReplayingEvent = function resetReplayingEvent() {
    ...
    var isReplayingEvent = function isReplayingEvent(event) {
    ...
    var batchedUpdates = function batchedUpdates(fn, a, b) {
    ...
    var setBatchingImplementation = function setBatchingImplementation(_batchedUpdatesImpl, _discreteUpdatesImpl, _flushSyncImpl) {
    ...
    var getListener = function getListener(inst, registrationName) {
        ...
        if (listener && typeof listener !== 'function') throw new Error("Expected `" + registrationName + "` listener to be a function, instead got a value of `" + (typeof listener === "undefined" ? "undefined" : _type_of._(listener)) + "` type.");
        return listener;
    };
    ...
    var onCommitRoot = function onCommitRoot(root, eventPriority) {
    ...
    var onPostCommitRoot = function onPostCommitRoot(root) {
    ...
    var setIsStrictModeForDevtools = function setIsStrictModeForDevtools(newIsStrictMode) {
    ...
    var injectProfilingHooks = function injectProfilingHooks(profilingHooks) {
        injectedProfilingHooks = profilingHooks;
    };
    var getLaneLabelMap = function getLaneLabelMap() {
        var map = new Map();
        var lane = 1;
    ...
    var markCommitStarted = function markCommitStarted(lanes) {
    ...
    var markCommitStopped = function markCommitStopped() {
    ...
    var markComponentRenderStarted = function markComponentRenderStarted(fiber) {
    ...
    var markComponentRenderStopped = function markComponentRenderStopped() {
    ...
    var markComponentPassiveEffectMountStarted = function markComponentPassiveEffectMountStarted(fiber) {
    ...
    var markComponentPassiveEffectMountStopped = function markComponentPassiveEffectMountStopped() {
    ...
    var markComponentPassiveEffectUnmountStarted = function markComponentPassiveEffectUnmountStarted(fiber) {
    ...
    var markComponentPassiveEffectUnmountStopped = function markComponentPassiveEffectUnmountStopped() {
    ...
    var markComponentLayoutEffectMountStarted = function markComponentLayoutEffectMountStarted(fiber) {
    ...
    var markComponentLayoutEffectMountStopped = function markComponentLayoutEffectMountStopped() {
    ...
    var markComponentLayoutEffectUnmountStarted = function markComponentLayoutEffectUnmountStarted(fiber) {
    ...
    var markComponentLayoutEffectUnmountStopped = function markComponentLayoutEffectUnmountStopped() {
    ...
    var markComponentErrored = function markComponentErrored(fiber, thrownValue, lanes) {
    ...
    var markComponentSuspended = function markComponentSuspended(fiber, wakeable, lanes) {
    ...
    var markLayoutEffectsStarted = function markLayoutEffectsStarted(lanes) {
    ...
    var markLayoutEffectsStopped = function markLayoutEffectsStopped() {
    ...
    var markPassiveEffectsStarted = function markPassiveEffectsStarted(lanes) {
    ...
    var markPassiveEffectsStopped = function markPassiveEffectsStopped() {
    ...
    var markRenderStarted = function markRenderStarted(lanes) {
        if (injectedProfilingHooks !== null && typeof injectedProfilingHooks.markRenderStarted === 'function') injectedProfilingHooks.markRenderStarted(lanes);
    };
    var markRenderYielded = function markRenderYielded() {
    ...
    var markRenderStopped = function markRenderStopped() {
    ...
    var markRenderScheduled = function markRenderScheduled(lane) {
    ...
    var markForceUpdateScheduled = function markForceUpdateScheduled(fiber, lane) {
    ...
    var markStateUpdateScheduled = function markStateUpdateScheduled(fiber, lane) {
    ...
    var clz32Fallback = function clz32Fallback(x) {
        var asUint = x >>> 0;
        if (asUint === 0) return 32;
        return 31 - (log(asUint) / LN2 | 0) | 0;
    };
    var getLabelForLane = function getLabelForLane(lane) {
    ...
    var getHighestPriorityPendingLanes = function getHighestPriorityPendingLanes(root) {
    ...
    var includesSyncLane = function includesSyncLane(lanes) {
    ...
    var includesOnlyNonUrgentLanes = function includesOnlyNonUrgentLanes(lanes) {
    ...
    var includesBlockingLane = function includesBlockingLane(root, lanes) {
        var SyncDefaultLanes = InputContinuousHydrationLane | InputContinuousLane | DefaultHydrationLane | DefaultLane;
        return (lanes & SyncDefaultLanes) !== NoLanes;
    };
    var includesExpiredLane = function includesExpiredLane(root, lanes) {
        return (lanes & root.expiredLanes) !== NoLanes;
    };
    var isTransitionLane = function isTransitionLane(lane) {
        return (lane & TransitionLanes) !== NoLanes;
    };
    var claimNextTransitionLane = function claimNextTransitionLane() {
        var lane = nextTransitionLane;
        nextTransitionLane <<= 1;
        if ((nextTransitionLane & TransitionLanes) === NoLanes) nextTransitionLane = TransitionLane1;
        return lane;
    };
    var claimNextRetryLane = function claimNextRetryLane() {
    ...
    var intersectLanes = function intersectLanes(a, b) {
        return a & b;
    };
    ...
    var getBumpedLaneForHydration = function getBumpedLaneForHydration(root, renderLanes) {
    ...
    var addFiberToLanesMap = function addFiberToLanesMap(root, fiber, lanes) {
    ...
    var movePendingFibersToMemoized = function movePendingFibersToMemoized(root, lanes) {
        if (!isDevToolsPresent) return;
        var pendingUpdatersLaneMap = root.pendingUpdatersLaneMap;
    ...
    var getTransitionsForLanes = function getTransitionsForLanes(root, lanes) {
        return null;
    };
    ...
    var runWithPriority = function runWithPriority(priority, fn) {
    ...
    var higherEventPriority = function higherEventPriority(a, b) {
        return a !== 0 && a < b ? a : b;
    };
    var lowerEventPriority = function lowerEventPriority(a, b) {
        return a === 0 || a > b ? a : b;
    };
    ...
    var isRootDehydrated = function isRootDehydrated(root) {
        var currentState = root.current.memoizedState;
        return currentState.isDehydrated;
    };
    var setAttemptSynchronousHydration = function setAttemptSynchronousHydration(fn) {
    ...
    var setGetCurrentUpdatePriority = function setGetCurrentUpdatePriority(fn) {
        getCurrentUpdatePriority$1 = fn;
    };
    var setAttemptHydrationAtPriority = function setAttemptHydrationAtPriority(fn) {
        attemptHydrationAtPriority = fn;
    };
    var isDiscreteEventThatRequiresHydration = function isDiscreteEventThatRequiresHydration(eventType) {
    ...
    var queueExplicitHydrationTarget = function queueExplicitHydrationTarget(target) {
    ...
    var dispatchContinuousEvent = function dispatchContinuousEvent(domEventName, eventSystemFlags, container, nativeEvent) {
        var previousPriority = getCurrentUpdatePriority();
        var prevTransition = ReactCurrentBatchConfig.transition;
        ReactCurrentBatchConfig.transition = null;
        try {
    ...
    var dispatchEventWithEnableCapturePhaseSelectiveHydrationWithoutDiscreteEventReplay = function dispatchEventWithEnableCapturePhaseSelectiveHydrationWithoutDiscreteEventReplay(domEventName, eventSystemFlags, targetContainer, nativeEvent) {
    ...
    var findInstanceBlockingEvent = function findInstanceBlockingEvent(domEventName, eventSystemFlags, targetContainer, nativeEvent) {
    ...
    var createSyntheticEvent = function createSyntheticEvent(Interface) {
        ...
        assign(SyntheticBaseEvent.prototype, {
            preventDefault: function preventDefault() {
                ...
                else if (_type_of._(event.returnValue) !== 'unknown') event.returnValue = false;
            ...
            stopPropagation: function stopPropagation() {
                ...
                else if (_type_of._(event.cancelBubble) !== 'unknown') event.cancelBubble = true;
    ...
    var getNodeForCharacterOffset = function getNodeForCharacterOffset(root, offset) {
    ...
    var getActiveElementDeep = function getActiveElementDeep() {
        ...
        while(_instanceof._(element, win.HTMLIFrameElement)){
    ...
    var accumulateSinglePhaseListeners = function accumulateSinglePhaseListeners(targetFiber, reactName, nativeEventType, inCapturePhase, accumulateTargetOnly, nativeEvent) {
    ...
    var checkForUnmatchedText = function checkForUnmatchedText(serverText, clientText, isConcurrentMode, shouldWarnDev) {
    ...
    var diffHydratedProperties = function diffHydratedProperties(domElement, tag, rawProps, parentNamespace, rootContainerElement, isConcurrentMode, shouldWarnDev) {
        var isCustomComponentTag;
    ...
    var diffHydratedText = function diffHydratedText(textNode, text, isConcurrentMode) {
    ...
    var prepareUpdate = function prepareUpdate(domElement, type, oldProps, newProps, rootContainerInstance, hostContext) {
        var hostContextDev = hostContext;
        if (_type_of._(newProps.children) !== _type_of._(oldProps.children) && (typeof newProps.children === 'string' || typeof newProps.children === 'number')) {
    ...
    var handleErrorInNextTick = function handleErrorInNextTick(error) {
        setTimeout(function() {
            throw error;
        });
    };
    ...
    var clearSuspenseBoundary = function clearSuspenseBoundary(parentInstance, suspenseInstance) {
    ...
    var clearSuspenseBoundaryFromContainer = function clearSuspenseBoundaryFromContainer(container, suspenseInstance) {
    ...
    var canHydrateSuspenseInstance = function canHydrateSuspenseInstance(instance) {
    ...
    var getSuspenseInstanceFallbackErrorDetails = function getSuspenseInstanceFallbackErrorDetails(instance) {
    ...
    var registerSuspenseInstanceRetry = function registerSuspenseInstanceRetry(instance, callback) {
    ...
    var getFirstHydratableChildWithinContainer = function getFirstHydratableChildWithinContainer(parentContainer) {
        return getNextHydratable(parentContainer.firstChild);
    };
    var getFirstHydratableChildWithinSuspenseInstance = function getFirstHydratableChildWithinSuspenseInstance(parentInstance) {
        return getNextHydratable(parentInstance.nextSibling);
    };
    var hydrateInstance = function hydrateInstance(instance, type, props, rootContainerInstance, hostContext, internalInstanceHandle, shouldWarnDev) {
    ...
    var hydrateTextInstance = function hydrateTextInstance(textInstance, text, internalInstanceHandle, shouldWarnDev) {
        precacheFiberNode(internalInstanceHandle, textInstance);
        var isConcurrentMode = (internalInstanceHandle.mode & ConcurrentMode) !== NoMode;
        return diffHydratedText(textInstance, text);
    };
    var hydrateSuspenseInstance = function hydrateSuspenseInstance(suspenseInstance, internalInstanceHandle) {
    ...
    var shouldDeleteUnhydratedTailInstances = function shouldDeleteUnhydratedTailInstances(parentType) {
        return parentType !== 'head' && parentType !== 'body';
    };
    var didNotMatchHydratedContainerTextInstance = function didNotMatchHydratedContainerTextInstance(parentContainer, textInstance, text, isConcurrentMode) {
        var shouldWarnDev = true;
        checkForUnmatchedText(textInstance.nodeValue, text, isConcurrentMode, shouldWarnDev);
    };
    var didNotMatchHydratedTextInstance = function didNotMatchHydratedTextInstance(parentType, parentProps, parentInstance, textInstance, text, isConcurrentMode) {
        if (parentProps[SUPPRESS_HYDRATION_WARNING$1] !== true) {
            var shouldWarnDev = true;
            checkForUnmatchedText(textInstance.nodeValue, text, isConcurrentMode, shouldWarnDev);
        }
    };
    var didNotHydrateInstanceWithinContainer = function didNotHydrateInstanceWithinContainer(parentContainer, instance) {
    ...
    var didNotHydrateInstanceWithinSuspenseInstance = function didNotHydrateInstanceWithinSuspenseInstance(parentInstance, instance) {
    ...
    var didNotHydrateInstance = function didNotHydrateInstance(parentType, parentProps, parentInstance, instance, isConcurrentMode) {
    ...
    var didNotFindHydratableInstanceWithinContainer = function didNotFindHydratableInstanceWithinContainer(parentContainer, type, props) {
        warnForInsertedHydratedElement(parentContainer, type);
    };
    var didNotFindHydratableTextInstanceWithinContainer = function didNotFindHydratableTextInstanceWithinContainer(parentContainer, text) {
        warnForInsertedHydratedText(parentContainer, text);
    };
    var didNotFindHydratableInstanceWithinSuspenseInstance = function didNotFindHydratableInstanceWithinSuspenseInstance(parentInstance, type, props) {
        var parentNode = parentInstance.parentNode;
        if (parentNode !== null) warnForInsertedHydratedElement(parentNode, type);
    };
    var didNotFindHydratableTextInstanceWithinSuspenseInstance = function didNotFindHydratableTextInstanceWithinSuspenseInstance(parentInstance, text) {
        var parentNode = parentInstance.parentNode;
        if (parentNode !== null) warnForInsertedHydratedText(parentNode, text);
    };
    var didNotFindHydratableInstance = function didNotFindHydratableInstance(parentType, parentProps, parentInstance, type, props, isConcurrentMode) {
        if (isConcurrentMode || parentProps[SUPPRESS_HYDRATION_WARNING$1] !== true) warnForInsertedHydratedElement(parentInstance, type);
    };
    var didNotFindHydratableTextInstance = function didNotFindHydratableTextInstance(parentType, parentProps, parentInstance, text, isConcurrentMode) {
        if (isConcurrentMode || parentProps[SUPPRESS_HYDRATION_WARNING$1] !== true) warnForInsertedHydratedText(parentInstance, text);
    };
    var errorHydratingContainer = function errorHydratingContainer(parentContainer) {
        error('An error occurred during hydration. The server HTML was replaced with client content in <%s>.', parentContainer.nodeName.toLowerCase());
    };
    var preparePortalMount = function preparePortalMount(portalInstance) {
        listenToAllSupportedEvents(portalInstance);
    };
    var detachDeletedInstance = function detachDeletedInstance(node) {
    ...
    var flushSyncCallbacksOnlyInLegacyMode = function flushSyncCallbacksOnlyInLegacyMode() {
        if (includesLegacySyncCallbacks) flushSyncCallbacks();
    };
    var isForkedChild = function isForkedChild(workInProgress) {
        warnIfNotHydrating();
        return (workInProgress.flags & Forked) !== NoFlags;
    };
    var getForksAtLevel = function getForksAtLevel(workInProgress) {
        warnIfNotHydrating();
        return treeForkCount;
    };
    var getTreeId = function getTreeId() {
        var overflow = treeContextOverflow;
        var idWithLeadingBit = treeContextId;
        var id = idWithLeadingBit & ~getLeadingBit(idWithLeadingBit);
        return id.toString(32) + overflow;
    };
    var pushTreeFork = function pushTreeFork(workInProgress, totalChildren) {
        warnIfNotHydrating();
    ...
    var pushTreeId = function pushTreeId(workInProgress, totalChildren, index) {
        warnIfNotHydrating();
    ...
    var pushMaterializedTreeId = function pushMaterializedTreeId(workInProgress) {
        warnIfNotHydrating();
    ...
    var getBitLength = function getBitLength(number) {
        return 32 - clz32(number);
    };
    var getLeadingBit = function getLeadingBit(id) {
        return 1 << getBitLength(id) - 1;
    };
    var popTreeContext = function popTreeContext(workInProgress) {
    ...
    var getSuspendedTreeContext = function getSuspendedTreeContext() {
        warnIfNotHydrating();
    ...
    var restoreSuspendedTreeContext = function restoreSuspendedTreeContext(workInProgress, suspendedContext) {
        warnIfNotHydrating();
        idStack[idStackIndex++] = treeContextId;
        idStack[idStackIndex++] = treeContextOverflow;
        idStack[idStackIndex++] = treeContextProvider;
    ...
    var warnIfNotHydrating = function warnIfNotHydrating() {
        if (!getIsHydrating()) error("Expected to be hydrating. This is a bug in React. Please file an issue.");
    };
    var warnIfHydrating = function warnIfHydrating() {
        if (isHydrating) error('We should not be hydrating here. This is a bug in React. Please file a bug.');
    };
    var markDidThrowWhileHydratingDEV = function markDidThrowWhileHydratingDEV() {
        didSuspendOrErrorDEV = true;
    };
    var didSuspendOrErrorWhileHydratingDEV = function didSuspendOrErrorWhileHydratingDEV() {
    ...
    var reenterHydrationStateFromDehydratedSuspenseInstance = function reenterHydrationStateFromDehydratedSuspenseInstance(fiber, suspenseInstance, treeContext) {
    ...
    var warnUnhydratedInstance = function warnUnhydratedInstance(returnFiber, instance) {
    ...
    var warnNonhydratedInstance = function warnNonhydratedInstance(returnFiber, fiber) {
    ...
    var shouldClientRenderOnMismatch = function shouldClientRenderOnMismatch(fiber) {
        return (fiber.mode & ConcurrentMode) !== NoMode && (fiber.flags & DidCapture) === NoFlags;
    };
    var throwOnHydrationMismatch = function throwOnHydrationMismatch(fiber) {
    ...
    var prepareToHydrateHostSuspenseInstance = function prepareToHydrateHostSuspenseInstance(fiber) {
        var suspenseState = fiber.memoizedState;
    ...
    var hasUnhydratedTailNodes = function hasUnhydratedTailNodes() {
        return isHydrating && nextHydratableInstance !== null;
    };
    var warnIfUnhydratedTailNodes = function warnIfUnhydratedTailNodes(fiber) {
        var nextInstance = nextHydratableInstance;
        while(nextInstance){
    ...
    var upgradeHydrationErrorsToRecoverable = function upgradeHydrationErrorsToRecoverable() {
    ...
    var queueHydrationError = function queueHydrationError(error) {
    ...
    var pushProvider = function pushProvider(providerFiber, context, nextValue) {
    ...
    var popProvider = function popProvider(context, providerFiber) {
        var currentValue = valueCursor.current;
        pop(valueCursor, providerFiber);
        context._currentValue = currentValue;
    };
    var scheduleContextWorkOnParentPath = function scheduleContextWorkOnParentPath(parent, renderLanes, propagationRoot) {
        var node = parent;
        while(node !== null){
    ...
    var propagateContextChange = function propagateContextChange(workInProgress, context, renderLanes) {
        propagateContextChange_eager(workInProgress, context, renderLanes);
    };
    var propagateContextChange_eager = function propagateContextChange_eager(workInProgress, context, renderLanes) {
    ...
    var readContext = function readContext(context) {
    ...
    var pushConcurrentUpdateQueue = function pushConcurrentUpdateQueue(queue) {
        if (concurrentQueues === null) concurrentQueues = [
            queue
        ];
        else concurrentQueues.push(queue);
    };
    var finishQueueingConcurrentUpdates = function finishQueueingConcurrentUpdates() {
    ...
    var enqueueConcurrentHookUpdate = function enqueueConcurrentHookUpdate(fiber, queue, update, lane) {
    ...
    var enqueueConcurrentHookUpdateAndEagerlyBailout = function enqueueConcurrentHookUpdateAndEagerlyBailout(fiber, queue, update, lane) {
        var interleaved = queue.interleaved;
        if (interleaved === null) {
            update.next = update;
            pushConcurrentUpdateQueue(queue);
    ...
    var enqueueConcurrentClassUpdate = function enqueueConcurrentClassUpdate(fiber, queue, update, lane) {
        var interleaved = queue.interleaved;
        if (interleaved === null) {
            update.next = update;
            pushConcurrentUpdateQueue(queue);
    ...
    var enqueueConcurrentRenderForLane = function enqueueConcurrentRenderForLane(fiber, lane) {
        return markUpdateLaneFromFiberToRoot(fiber, lane);
    };
    ...
    var enqueueUpdate = function enqueueUpdate(fiber, update, lane) {
        var updateQueue = fiber.updateQueue;
    ...
    var entangleTransitions = function entangleTransitions(root, fiber, lane) {
        var updateQueue = fiber.updateQueue;
    ...
    var constructClassInstance = function constructClassInstance(workInProgress, ctor, props) {
        ...
        if ('contextType' in ctor) {
            ...
            if (!isValid && !didWarnAboutInvalidateContextType.has(ctor)) {
                ...
                else if (typeof contextType !== 'object') addendum = ' However, it is set to a ' + (typeof contextType === "undefined" ? "undefined" : _type_of._(contextType)) + '.';
    ...
    var resolveLazy = function resolveLazy(lazyType) {
    ...
    var registerMutableSourceForHydration = function registerMutableSourceForHydration(root, mutableSource) {
    ...
    var checkDepsAreArrayDev = function checkDepsAreArrayDev(deps) {
        if (deps !== undefined && deps !== null && !isArray(deps)) error("%s received a final argument that is not an array (instead, received `%s`). When specified, the final argument must be an array.", currentHookNameInDev, typeof deps === "undefined" ? "undefined" : _type_of._(deps));
    };
    ...
    var checkDidRenderIdHook = function checkDidRenderIdHook() {
    ...
    var mountSyncExternalStore = function mountSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
    ...
    var updateSyncExternalStore = function updateSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
        var fiber = currentlyRenderingFiber$1;
        var hook = updateWorkInProgressHook();
    ...
    var pushStoreConsistencyCheck = function pushStoreConsistencyCheck(fiber, getSnapshot, renderedSnapshot) {
    ...
    var updateStoreInstance = function updateStoreInstance(fiber, inst, nextSnapshot, getSnapshot) {
        inst.value = nextSnapshot;
        inst.getSnapshot = getSnapshot;
        if (checkIfSnapshotChanged(inst)) forceStoreRerender(fiber);
    };
    var subscribeToStore = function subscribeToStore(fiber, inst, subscribe) {
    ...
    var forceStoreRerender = function forceStoreRerender(fiber) {
    ...
    var mountInsertionEffect = function mountInsertionEffect(create, deps) {
        return mountEffectImpl(Update, Insertion, create, deps);
    };
    var updateInsertionEffect = function updateInsertionEffect(create, deps) {
    ...
    var mountImperativeHandle = function mountImperativeHandle(ref, create, deps) {
        if (typeof create !== 'function') error("Expected useImperativeHandle() second argument to be a function that creates a handle. Instead received: %s.", create !== null ? typeof create === "undefined" ? "undefined" : _type_of._(create) : 'null');
    ...
    var updateDeferredValueImpl = function updateDeferredValueImpl(hook, prevValue, value) {
    ...
    var startTransition = function startTransition(setPending, callback, options) {
        var previousPriority = getCurrentUpdatePriority();
    ...
    var dispatchReducerAction = function dispatchReducerAction(fiber, queue, action) {
    ...
    var dispatchSetState = function dispatchSetState(fiber, queue, action) {
        if (typeof arguments[3] === 'function') error("State updates from the useState() and useReducer() Hooks don't support the second callback argument. To execute a side effect after rendering, declare it in the component body with useEffect().");
        var lane = requestUpdateLane(fiber);
        var update = {
            lane: lane,
    ...
    var isRenderPhaseUpdate = function isRenderPhaseUpdate(fiber) {
        var alternate = fiber.alternate;
        return fiber === currentlyRenderingFiber$1 || alternate !== null && alternate === currentlyRenderingFiber$1;
    };
    var enqueueRenderPhaseUpdate = function enqueueRenderPhaseUpdate(queue, update) {
    ...
    var entangleTransitionUpdate = function entangleTransitionUpdate(root, queue, lane) {
        if (isTransitionLane(lane)) {
    ...
    var markUpdateInDevTools = function markUpdateInDevTools(fiber, lane, action) {
        markStateUpdateScheduled(fiber, lane);
    };
    var isCurrentUpdateNested = function isCurrentUpdateNested() {
        return currentUpdateIsNested;
    };
    var markNestedUpdateScheduled = function markNestedUpdateScheduled() {
        nestedUpdateScheduled = true;
    };
    var resetNestedUpdateFlag = function resetNestedUpdateFlag() {
        currentUpdateIsNested = false;
        nestedUpdateScheduled = false;
    };
    var syncNestedUpdateFlag = function syncNestedUpdateFlag() {
    ...
    var recordLayoutEffectDuration = function recordLayoutEffectDuration(fiber) {
    ...
    var recordPassiveEffectDuration = function recordPassiveEffectDuration(fiber) {
    ...
    var startLayoutEffectTimer = function startLayoutEffectTimer() {
        layoutEffectStartTime = now$1();
    };
    var startPassiveEffectTimer = function startPassiveEffectTimer() {
    ...
    var createCapturedValueAtFiber = function createCapturedValueAtFiber(value, source) {
        return {
            value: value,
            source: source,
    ...
    var createCapturedValue = function createCapturedValue(value, digest, stack) {
        return {
            value: value,
            source: null,
    ...
    var attachRetryListener = function attachRetryListener(suspenseBoundary, root, wakeable, lanes) {
    ...
    var resetSuspendedComponent = function resetSuspendedComponent(sourceFiber, rootRenderLanes) {
    ...
    var getNearestSuspenseBoundaryToCapture = function getNearestSuspenseBoundaryToCapture(returnFiber) {
    ...
    var markSuspenseBoundaryShouldCapture = function markSuspenseBoundaryShouldCapture(suspenseBoundary, returnFiber, sourceFiber, root, rootRenderLanes) {
    ...
    var getSuspendedCache = function getSuspendedCache() {
        return null;
    };
    ...
    var updateMemoComponent = function updateMemoComponent(current, workInProgress, Component, nextProps, renderLanes) {
        if (current === null) {
    ...
    var updateSimpleMemoComponent = function updateSimpleMemoComponent(current, workInProgress, Component, nextProps, renderLanes) {
        if (workInProgress.type !== workInProgress.elementType) {
    ...
    var mountHostRootWithoutHydrating = function mountHostRootWithoutHydrating(current, workInProgress, nextChildren, renderLanes, recoverableError) {
        resetHydrationState();
    ...
    var mountLazyComponent = function mountLazyComponent(_current, workInProgress, elementType, renderLanes) {
    ...
    var mountWorkInProgressOffscreenFiber = function mountWorkInProgressOffscreenFiber(offscreenProps, mode, renderLanes) {
        return createFiberFromOffscreen(offscreenProps, mode, NoLanes, null);
    };
    var updateWorkInProgressOffscreenFiber = function updateWorkInProgressOffscreenFiber(current, offscreenProps) {
    ...
    var retrySuspenseComponentWithoutHydrating = function retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes, recoverableError) {
    ...
    var mountSuspenseFallbackAfterRetryWithoutHydrating = function mountSuspenseFallbackAfterRetryWithoutHydrating(current, workInProgress, primaryChildren, fallbackChildren, renderLanes) {
    ...
    var mountDehydratedSuspenseComponent = function mountDehydratedSuspenseComponent(workInProgress, suspenseInstance, renderLanes) {
        if ((workInProgress.mode & ConcurrentMode) === NoMode) {
    ...
    var updateDehydratedSuspenseComponent = function updateDehydratedSuspenseComponent(current, workInProgress, didSuspend, nextProps, suspenseInstance, suspenseState, renderLanes) {
        if (!didSuspend) {
            warnIfHydrating();
    ...
    var scheduleSuspenseWorkOnFiber = function scheduleSuspenseWorkOnFiber(fiber, renderLanes, propagationRoot) {
        fiber.lanes = mergeLanes(fiber.lanes, renderLanes);
        var alternate = fiber.alternate;
        if (alternate !== null) alternate.lanes = mergeLanes(alternate.lanes, renderLanes);
    ...
    var initSuspenseListRenderState = function initSuspenseListRenderState(workInProgress, isBackwards, tail, lastContentRow, tailMode) {
    ...
    var updateSuspenseListComponent = function updateSuspenseListComponent(current, workInProgress, renderLanes) {
        var nextProps = workInProgress.pendingProps;
    ...
    var resetSuspendedCurrentOnMountInLegacyMode = function resetSuspendedCurrentOnMountInLegacyMode(current, workInProgress) {
        if ((workInProgress.mode & ConcurrentMode) === NoMode) {
            if (current !== null) {
    ...
    var checkScheduledUpdateOrContext = function checkScheduledUpdateOrContext(current, renderLanes) {
        var updateLanes = current.lanes;
        if (includesSomeLane(updateLanes, renderLanes)) return true;
        return false;
    };
    var attemptEarlyBailoutIfNoScheduledUpdate = function attemptEarlyBailoutIfNoScheduledUpdate(current, workInProgress, renderLanes) {
        switch(workInProgress.tag){
            case HostRoot:
                pushHostRootContext(workInProgress);
                var root = workInProgress.stateNode;
    ...
    var completeDehydratedSuspenseBoundary = function completeDehydratedSuspenseBoundary(current, workInProgress, nextState) {
    ...
    var unwindWork = function unwindWork(current, workInProgress, renderLanes) {
        popTreeContext(workInProgress);
        switch(workInProgress.tag){
            case ClassComponent:
                var Component = workInProgress.type;
    ...
    var unwindInterruptedWork = function unwindInterruptedWork(current, interruptedWork, renderLanes) {
    ...
    var reportUncaughtErrorInDEV = function reportUncaughtErrorInDEV(error) {
        invokeGuardedCallback(null, function() {
            throw error;
        });
        clearCaughtError();
    };
    var safelyCallCommitHookLayoutEffectListMount = function safelyCallCommitHookLayoutEffectListMount(current, nearestMountedAncestor) {
        try {
    ...
    var safelyCallComponentWillUnmount = function safelyCallComponentWillUnmount(current, nearestMountedAncestor, instance) {
        try {
    ...
    var safelyCallComponentDidMount = function safelyCallComponentDidMount(current, nearestMountedAncestor, instance) {
        try {
    ...
    var safelyAttachRef = function safelyAttachRef(current, nearestMountedAncestor) {
        try {
    ...
    var safelyDetachRef = function safelyDetachRef(current, nearestMountedAncestor) {
        var ref = current.ref;
        if (ref !== null) {
            if (typeof ref === 'function') {
                var retVal;
    ...
    var safelyCallDestroy = function safelyCallDestroy(current, nearestMountedAncestor, destroy) {
        try {
            destroy();
        } catch (error) {
            captureCommitPhaseError(current, nearestMountedAncestor, error);
    ...
    var commitHookEffectListUnmount = function commitHookEffectListUnmount(flags, finishedWork, nearestMountedAncestor) {
    ...
    var commitHookEffectListMount = function commitHookEffectListMount(flags, finishedWork) {
        var updateQueue = finishedWork.updateQueue;
        var lastEffect = updateQueue !== null ? updateQueue.lastEffect : null;
        if (lastEffect !== null) {
            var firstEffect = lastEffect.next;
    ...
    var commitPassiveEffectDurations = function commitPassiveEffectDurations(finishedRoot, finishedWork) {
    ...
    var reappearLayoutEffectsOnFiber = function reappearLayoutEffectsOnFiber(node) {
        switch(node.tag){
            case FunctionComponent:
            case ForwardRef:
            case SimpleMemoComponent:
    ...
    var commitDeletionEffects = function commitDeletionEffects(root, returnFiber, deletedFiber) {
    ...
    var recursivelyTraverseDeletionEffects = function recursivelyTraverseDeletionEffects(finishedRoot, nearestMountedAncestor, parent) {
    ...
    var commitDeletionEffectsOnFiber = function commitDeletionEffectsOnFiber(finishedRoot, nearestMountedAncestor, deletedFiber) {
    ...
    var commitSuspenseCallback = function commitSuspenseCallback(finishedWork) {
    ...
    var commitMutationEffects = function commitMutationEffects(root, finishedWork, committedLanes) {
    ...
    var recursivelyTraverseMutationEffects = function recursivelyTraverseMutationEffects(root, parentFiber, lanes) {
    ...
    var commitMutationEffectsOnFiber = function commitMutationEffectsOnFiber(finishedWork, root, lanes) {
        var current = finishedWork.alternate;
        var flags = finishedWork.flags;
        switch(finishedWork.tag){
            case FunctionComponent:
    ...
    var commitReconciliationEffects = function commitReconciliationEffects(finishedWork) {
        var flags = finishedWork.flags;
        if (flags & Placement) {
            try {
    ...
    var commitLayoutEffects = function commitLayoutEffects(finishedWork, root, committedLanes) {
        inProgressLanes = committedLanes;
        inProgressRoot = root;
    ...
    var disappearLayoutEffects_begin = function disappearLayoutEffects_begin(subtreeRoot) {
        while(nextEffect !== null){
            var fiber = nextEffect;
    ...
    var disappearLayoutEffects_complete = function disappearLayoutEffects_complete(subtreeRoot) {
        while(nextEffect !== null){
            var fiber = nextEffect;
            if (fiber === subtreeRoot) {
                nextEffect = null;
    ...
    var reappearLayoutEffects_begin = function reappearLayoutEffects_begin(subtreeRoot) {
        while(nextEffect !== null){
            var fiber = nextEffect;
            var firstChild = fiber.child;
    ...
    var reappearLayoutEffects_complete = function reappearLayoutEffects_complete(subtreeRoot) {
        while(nextEffect !== null){
            var fiber = nextEffect;
            setCurrentFiber(fiber);
            try {
    ...
    var commitPassiveMountEffects = function commitPassiveMountEffects(root, finishedWork, committedLanes, committedTransitions) {
        nextEffect = finishedWork;
        commitPassiveMountEffects_begin(finishedWork, root, committedLanes, committedTransitions);
    };
    var commitPassiveMountEffects_begin = function commitPassiveMountEffects_begin(subtreeRoot, root, committedLanes, committedTransitions) {
        while(nextEffect !== null){
            var fiber = nextEffect;
            var firstChild = fiber.child;
    ...
    var commitPassiveMountEffects_complete = function commitPassiveMountEffects_complete(subtreeRoot, root, committedLanes, committedTransitions) {
        while(nextEffect !== null){
            var fiber = nextEffect;
    ...
    var commitPassiveMountOnFiber = function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions) {
        switch(finishedWork.tag){
            case FunctionComponent:
            case ForwardRef:
            case SimpleMemoComponent:
    ...
    var invokeLayoutEffectMountInDEV = function invokeLayoutEffectMountInDEV(fiber) {
        switch(fiber.tag){
            case FunctionComponent:
            case ForwardRef:
            case SimpleMemoComponent:
    ...
    var invokePassiveEffectMountInDEV = function invokePassiveEffectMountInDEV(fiber) {
        switch(fiber.tag){
            case FunctionComponent:
            case ForwardRef:
            case SimpleMemoComponent:
    ...
    var invokeLayoutEffectUnmountInDEV = function invokeLayoutEffectUnmountInDEV(fiber) {
        switch(fiber.tag){
            case FunctionComponent:
            case ForwardRef:
            case SimpleMemoComponent:
    ...
    var invokePassiveEffectUnmountInDEV = function invokePassiveEffectUnmountInDEV(fiber) {
        switch(fiber.tag){
            case FunctionComponent:
            case ForwardRef:
            case SimpleMemoComponent:
    ...
    var isLegacyActEnvironment = function isLegacyActEnvironment(fiber) {
        var isReactActEnvironmentGlobal = typeof IS_REACT_ACT_ENVIRONMENT !== 'undefined' ? IS_REACT_ACT_ENVIRONMENT : undefined;
        var jestIsDefined = typeof jest !== 'undefined';
        return jestIsDefined && isReactActEnvironmentGlobal !== false;
    };
    var isConcurrentActEnvironment = function isConcurrentActEnvironment() {
        var isReactActEnvironmentGlobal = typeof IS_REACT_ACT_ENVIRONMENT !== 'undefined' ? IS_REACT_ACT_ENVIRONMENT : undefined;
    ...
    var scheduleUpdateOnFiber = function scheduleUpdateOnFiber(root, fiber, lane, eventTime) {
    ...
    var scheduleInitialHydrationOnRoot = function scheduleInitialHydrationOnRoot(root, lane, eventTime) {
        var current = root.current;
        current.lanes = lane;
        markRootUpdated(root, lane, eventTime);
        ensureRootIsScheduled(root, eventTime);
    };
    var isUnsafeClassRenderPhaseUpdate = function isUnsafeClassRenderPhaseUpdate(fiber) {
    ...
    var recoverFromConcurrentError = function recoverFromConcurrentError(root, errorRetryLanes) {
    ...
    var queueRecoverableErrors = function queueRecoverableErrors(errors) {
    ...
    var isRenderConsistentWithExternalStores = function isRenderConsistentWithExternalStores(finishedWork) {
        var node = finishedWork;
        while(true){
    ...
    var flushSync = function flushSync(fn) {
    ...
    var isAlreadyRendering = function isAlreadyRendering() {
    ...
    var renderDidError = function renderDidError(error) {
    ...
    var commitRoot = function commitRoot(root, recoverableErrors, transitions) {
    ...
    var commitRootImpl = function commitRootImpl(root, recoverableErrors, transitions, renderPriorityLevel) {
    ...
    var enqueuePendingPassiveProfilerEffect = function enqueuePendingPassiveProfilerEffect(fiber) {
    ...
    var captureCommitPhaseError = function captureCommitPhaseError(sourceFiber, nearestMountedAncestor, error$1) {
    ...
    var retryDehydratedSuspenseBoundary = function retryDehydratedSuspenseBoundary(boundaryFiber) {
    ...
    var commitDoubleInvokeEffectsInDEV = function commitDoubleInvokeEffectsInDEV(fiber, hasPassiveEffects) {
        setCurrentFiber(fiber);
    ...
    var invokeEffectsInDev = function invokeEffectsInDev(firstChild, fiberFlags, invokeEffectFn) {
    ...
    var restorePendingUpdaters = function restorePendingUpdaters(root, lanes) {
        if (isDevToolsPresent) {
            var memoizedUpdaters = root.memoizedUpdaters;
    ...
    var scheduleCallback$1 = function scheduleCallback$1(priorityLevel, callback) {
    ...
    var cancelCallback$1 = function cancelCallback$1(callbackNode) {
    ...
    var warnIfUpdatesNotWrappedWithActDEV = function warnIfUpdatesNotWrappedWithActDEV(fiber) {
    ...
    var warnIfSuspenseResolutionNotWrappedWithActDEV = function warnIfSuspenseResolutionNotWrappedWithActDEV(root) {
    ...
    var setIsRunningInsertionEffect = function setIsRunningInsertionEffect(isRunning) {
    ...
    var createHostRootFiber = function createHostRootFiber(tag, isStrictMode, concurrentUpdatesByDefaultOverride) {
        var mode;
    ...
    var createFiberFromTypeAndProps = function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
        ...
        if (typeof type === 'function') {
            ...
            default:
                ...
                if (ownerName) info += '\n\nCheck the render method of `' + ownerName + '`.';
                throw new Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) " + ("but got: " + (type == null ? type : typeof type === "undefined" ? "undefined" : _type_of._(type)) + "." + info));
        }
    ...
    var createFiberFromProfiler = function createFiberFromProfiler(pendingProps, mode, lanes, key) {
        if (typeof pendingProps.id !== 'string') error('Profiler must specify an "id" of type `string` as a prop. Received the type `%s` instead.', _type_of._(pendingProps.id));
    ...
    var createFiberFromDehydratedFragment = function createFiberFromDehydratedFragment(dehydratedNode) {
    ...
    var FiberRootNode = function FiberRootNode(containerInfo, tag, hydrate, identifierPrefix, onRecoverableError) {
        this.tag = tag;
    ...
    var createFiberRoot = function createFiberRoot(containerInfo, tag, hydrate, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
    ...
    var createContainer = function createContainer(containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
        var hydrate = false;
        var initialChildren = null;
        return createFiberRoot(containerInfo, tag, hydrate, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError);
    };
    var createHydrationContainer = function createHydrationContainer(initialChildren, callback, containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
        var hydrate = true;
    ...
    var attemptSynchronousHydration$1 = function attemptSynchronousHydration$1(fiber) {
        switch(fiber.tag){
            case HostRoot:
    ...
    var shouldError = function shouldError(fiber) {
    ...
    var ReactDOMRoot = function ReactDOMRoot(internalRoot) {
        this._internalRoot = internalRoot;
    };
    var createRoot = function createRoot(container, options) {
    ...
    var ReactDOMHydrationRoot = function ReactDOMHydrationRoot(internalRoot) {
        this._internalRoot = internalRoot;
    };
    var scheduleHydration = function scheduleHydration(target) {
        if (target) queueExplicitHydrationTarget(target);
    };
    var hydrateRoot = function hydrateRoot(container, initialChildren, options) {
    ...
    var isValidContainerLegacy = function isValidContainerLegacy(node) {
        return !!(node && (node.nodeType === ELEMENT_NODE || node.nodeType === DOCUMENT_NODE || node.nodeType === DOCUMENT_FRAGMENT_NODE || node.nodeType === COMMENT_NODE && node.nodeValue === ' react-mount-point-unstable '));
    };
    var warnIfReactDOMContainerInDEV = function warnIfReactDOMContainerInDEV(container) {
    ...
    var noopOnRecoverableError = function noopOnRecoverableError() {};
    var legacyCreateRootFromDOMContainer = function legacyCreateRootFromDOMContainer(container, initialChildren, parentComponent, callback, isHydrationContainer) {
    ...
    var createRoot$1 = function createRoot$1(container, options) {
    ...
    var hydrateRoot$1 = function hydrateRoot$1(container, initialChildren, options) {
    ...
    var flushSync$1 = function flushSync$1(fn) {
    ...
    var Scheduler = __webpack_require__("./node_modules/.pnpm/scheduler@0.23.0/node_modules/scheduler/index.js");
    ...
    validateProperty$1 = function validateProperty$1(tagName, name, value, eventRegistry) {
        ...
        if (lowerCasedName === 'is' && value !== null && value !== undefined && typeof value !== 'string') {
            error("Received a `%s` for a string attribute `is`. If this is expected, cast the value to a string.", typeof value === "undefined" ? "undefined" : _type_of._(value));
            warnedProperties$1[name] = true;
            return true;
        }
    ...
    warnForInvalidEventListener = function warnForInvalidEventListener(registrationName, listener) {
        ...
        else error('Expected `%s` listener to be a function, instead got a value of `%s` type.', registrationName, typeof listener === "undefined" ? "undefined" : _type_of._(listener));
    };
...
"./node_modules/.pnpm/react-dom@18.2.0_react@18.2.0/node_modules/react-dom/index.js": function (module, exports, __webpack_require__) {
'use strict';
function checkDCE() {
...
module.exports = __webpack_require__("./node_modules/.pnpm/react-dom@18.2.0_react@18.2.0/node_modules/react-dom/cjs/react-dom.development.js");
},
"./node_modules/.pnpm/react@18.2.0/node_modules/react/cjs/react-jsx-dev-runtime.development.js": function (module, exports, __webpack_require__) {
'use strict';
var _instanceof = __webpack_require__("./node_modules/.pnpm/@swc+helpers@0.5.1/node_modules/@swc/helpers/esm/_instanceof.js");
var _type_of = __webpack_require__("./node_modules/.pnpm/@swc+helpers@0.5.1/node_modules/@swc/helpers/esm/_type_of.js");
(function() {
    ...
    var jsxDEV = function jsxDEV(type, config, maybeKey, source, self) {
        var propName;
        var props = {};
        var key = null;
        var ref = null;
    ...
    var jsxWithValidation = function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
        ...
        if (!validType) {
            ...
            } else typeString = typeof type === "undefined" ? "undefined" : _type_of._(type);
...
"./node_modules/.pnpm/react@18.2.0/node_modules/react/cjs/react.development.js": function (module, exports, __webpack_require__) {
'use strict';
var _instanceof = __webpack_require__("./node_modules/.pnpm/@swc+helpers@0.5.1/node_modules/@swc/helpers/esm/_instanceof.js");
var _type_of = __webpack_require__("./node_modules/.pnpm/@swc+helpers@0.5.1/node_modules/@swc/helpers/esm/_type_of.js");
(function() {
    ...
    var forwardRef = function forwardRef(render) {
        ...
        else if (typeof render !== 'function') error('forwardRef requires a render function but was given %s.', render === null ? 'null' : typeof render === "undefined" ? "undefined" : _type_of._(render));
    ...
    var memo = function memo(type, compare) {
        if (!isValidElementType(type)) error("memo: The first argument must be a component. Instead received: %s", type === null ? 'null' : typeof type === "undefined" ? "undefined" : _type_of._(type));
        var elementType = {
...
'use strict';
module.exports = __webpack_require__("./node_modules/.pnpm/react@18.2.0/node_modules/react/cjs/react.development.js");
},
"./node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-dev-runtime.js": function (module, exports, __webpack_require__) {
'use strict';
module.exports = __webpack_require__("./node_modules/.pnpm/react@18.2.0/node_modules/react/cjs/react-jsx-dev-runtime.development.js");
},
